...
const checkIn = function (flightNum, passenger) {
  ...
  if (passenger.passport === 232355235) {
    alert('Check In');
  } else {
...
transformer('Javascript is the best!', areWord);
...
book.call(lufthansa, 239, 'Mary Choper');
console.log(lufthansa);
...
book.call(swiss, 584, 'Mary Copper');
console.log(swiss);
